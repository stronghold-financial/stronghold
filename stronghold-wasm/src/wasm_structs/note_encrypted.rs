use stronghold_rust::sapling_bls12;
use stronghold_rust::MerkleNote;
...
mod tests {
    ...
    use super::*;
    use stronghold_rust::merkle_note::MerkleNote;
    use stronghold_rust::note::Memo;
    use stronghold_rust::sapling_bls12::Note;
    use stronghold_rust::SaplingKey;
