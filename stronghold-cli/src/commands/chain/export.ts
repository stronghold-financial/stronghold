...
import { GENESIS_BLOCK_SEQUENCE, Assert } from 'stronghold'
...
export default class Export extends StrongholdCommand {
  ...
  static flags = {
    ...
    path: flags.string({
      ...
      required: false,
      default: '../stronghold-graph-explorer/src/data.json',
