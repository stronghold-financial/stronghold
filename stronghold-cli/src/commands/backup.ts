...
import { FileUtils } from 'stronghold'

export default class Backup extends StrongholdCommand {
  static hidden = true
  ...
  async start(): Promise<void> {
    ...
    const destDir = await fsAsync.mkdtemp(path.join(os.tmpdir(), `stronghold.backup`))
