...
import { createRootLogger, Logger, ConfigOptions, StrongholdSdk, ConnectionError } from 'stronghold'
import {
  DataDirFlagKey,
  DatabaseFlagKey,
  ConfigFlagKey,
...
export abstract class StrongholdCommand extends Command {
  ...
  async init(): Promise<void> {
    ...
    this.sdk = await StrongholdSdk.init({
      agent: 'cli',
