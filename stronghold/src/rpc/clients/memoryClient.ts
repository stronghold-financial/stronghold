...
import { StrongholdRpcClient } from './rpcClient'
import { MemoryAdapter } from '../adapters'
import { Response } from '../response'

export class StrongholdMemoryClient extends StrongholdRpcClient {
  ...
  async connect(node: StrongholdNode): Promise<void> {
