...
> {
  ...
  private forceUpgrade = (db: unknown, oldVersion: number): Promise<void> => {
    ...
    this.logger.error(
      `You are running a newer version of Stronghold on an older database.\n` +
        `Wipe your database using "stronghold reset" or delete your data directory at ~/.stronghold\n`,
    )
...
export type StrongholdBlockchain = Blockchain<
  StrongholdNoteEncrypted,
  WasmNoteEncryptedHash,
  StrongholdTransaction,
  SerializedWasmNoteEncrypted,
