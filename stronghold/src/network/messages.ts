...
/**
 * The type of a Stronghold message. This is an exhaustive list of
 * the messages that are sent from StrongholdNode. Other messages may
...
export type NewTransactionMessage = Gossip<
  ...
  UnwrapPromise<ReturnType<StrongholdVerifier['verifyNewTransaction']>>
>
