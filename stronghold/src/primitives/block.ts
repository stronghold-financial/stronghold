...
import { StrongholdTransaction, SerializedTransaction, Transaction } from './transaction'
...
export type StrongholdBlock = Block<
  StrongholdNoteEncrypted,
  WasmNoteEncryptedHash,
...
export type StrongholdBlockSerialized = SerializedBlock<
  SerializedWasmNoteEncryptedHash,
  SerializedTransaction
>
