...
import { StrongholdNoteEncrypted, WasmNoteEncryptedHash } from './noteEncrypted'
import { Nullifier } from './nullifier'
import { Serde } from '../serde'
import { VerificationResult, VerificationResultReason } from '../consensus/verifier'
import { WasmTransactionPosted } from 'stronghold-wasm-nodejs'
...
export class StrongholdTransaction
 ...
 */
export class TransactionSerde implements Serde<StrongholdTransaction, SerializedTransaction> {
